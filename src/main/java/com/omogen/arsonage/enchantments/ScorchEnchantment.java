...
public class ScorchEnchantment {
	...
	public static List<Entity> getEntitiesAroundAttacker(Entity attacker, int enchantmentLevel) {
        ServerLevel serverLevel = attacker.getServer().getLevel(attacker.level().dimension());
        ...
        List<Entity> entities = serverLevel.getEntitiesOfClass(Entity.class, boundingBox, entity -> entity != attacker && entity instanceof LivingEntity);
